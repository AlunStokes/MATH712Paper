...
Where not otherwise cited, facts should be supposed to have been taken from the lectures — which themselves will periodically include references or suggestions for further reading material. For exteriorly sourced information, the citations are included along with the rest at the end of each chapter, as one would expect.
