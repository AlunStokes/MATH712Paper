...
\abstract*{One can imagine the collective sighs of all that read through the previous section to get to this, the \emph{exciting} part of the module, almost deafening. Here we will first start our proper discussion of the \pwt, along with some bits and bobs as to how we will prove it, followed by some previews of what it entails. There are two broad \emph{bits} to the proof we will discuss -- although each is deserving of a chapter (or perhaps even more) on its own, and so their proofs are outsourced to later to come parts. For now, we start by dipping our toes into what we've been building to through the last entire first part.}

\abstract{One can imagine the collective sighs of all that read through the previous section to get to this, the \emph{exciting} part of the module, almost deafening. Here we will first start our proper discussion of the \pwt, along with some bits and bobs as to how we will prove it, followed by some previews of what i t entails. There are two broad \emph{bits} to the proof we will discuss -- although each is deserving of a chapter (or perhaps even more) on its own, and so their proofs are outsourced to later to come parts. For now, we start by dipping our toes into what we've been building to throughout the last entire first part.}
...
\footnote{Please note that this horizontal line is \emph{not} intended to cause any calming effects, as we have used a \textit{similar} (but distinct) line previously. Delineation is not only all we intend it to be used for, but it is all that the reader is permitted to take from it. Observe with caution and integrity.}
