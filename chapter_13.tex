...
\begin{remark}
  ...
  \begin{exercise}
    As an exercise of \emph{this} author to the reader, attempt to prove that the above expansion admits QE. For a proof of this fact, should one be feeling lazy, see \cite{dolich_structures_2009}.
  \end{exercise}
\end{remark}
